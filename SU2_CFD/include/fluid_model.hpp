...
public:
   ...
   */
  virtual void CalcdPdU(su2double *V, su2double *val_eves, CConfig *config, su2double *val_dPdU);
  ...
  /*!
   * \brief Calculate the species enthalpy
   */
  virtual su2double CalcHs(CConfig *config, su2double val_T, su2double val_eves, unsigned short val_Species);

  /*!
   * \brief Calculate Cv_ve for a species
   */
  virtual su2double CalcCvve(su2double val_Tve, CConfig *config, unsigned short val_Species);

  /*!
   * \brief Calculate derivatve of temperatrue wrt to velocity
   */
  virtual void CalcdTdU(su2double *V, CConfig *config, su2double *val_dTdU);

  /*!
   * \brief Calculate derivatve of vibe-elec temperature wrt to velocity
   */
  virtual void CalcdTvedU(su2double *V, su2double *val_eves, CConfig *config,
...
public:
   ...
   * \param[in] rho - second thermodynamic variable.
   */
  su2double CalcHs(CConfig *config, su2double val_T,
   ...
   * \param[in] th2 - second thermodynamic variable (s).
   */
  void CalcdTdU(su2double *V, CConfig *config, su2double *val_dTdU);
