 ...
 * \brief Definition of the trapezoidal map class members.
...
#include "../include/CTrapezoidalMap.hpp"
...
using namespace std;
  ...
  while (i_band < n_bands_x) {
    ...
    while (i_edge < n_edges) {
      ...
      if (((edge_limits_x[i_edge][0] <= band_lower_x) and
        ...
        su2double x_0 = edge_limits_x[i_edge][0];
        su2double y_0 = edge_limits_y[i_edge][0];

        su2double dy_edge = edge_limits_y[i_edge][1] - edge_limits_y[i_edge][0];
        su2double dx_edge = edge_limits_x[i_edge][1] - edge_limits_x[i_edge][0];
        su2double x_band_mid = (band_lower_x + band_upper_x) / 2.0;
  ...
  unsigned long CTrapezoidalMap::GetTriangle(su2double val_x,
                                                      su2double val_y) {
