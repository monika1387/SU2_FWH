...
def main():
    ...
    parser.add_option("-o", "--optimizer", dest="optimizer", default="SLSQP",
                      help="The method for solving the optimization problem (SLSQP, MMA, AUGLAG_MMA)", metavar="OPTIMIZER")
    ...
    options.optimizer   = options.optimizer.upper()
...
def shape_optimization( filename                , 
    ...
    # Optimize
    SU2.opt.NLOPT(project,optimizer, x0,xb_low,xb_up,its,accu)
